...
for n_cluster = 2:10
    ...
    [rmse_test_nocollab,mean_rmse_test_nocollab,cell_Y_hat_test_nocollab] = ...
        gran_model_test(test_data, P, center_site_nocollab, cell_A_opt_nocollab, m, n_cluster);
        % 算法运行时间
        time_asoc(i_run) = toc;
        ...
        parfor i_site = 1:P
            ...
            y_all = cell_Y_hat_train_nocollab{i_site};  % 获取第 i_site 站点的预测值列向量
        ...
        % index_V_test = index_gran(test_data(:,end),a_test,b_test);
        % disp(['ASOC各端独立算法测试集的粒度性能评价指标为: ', num2str(index_V_test)]);
